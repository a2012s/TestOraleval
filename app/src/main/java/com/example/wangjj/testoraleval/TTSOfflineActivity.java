...
public class TTSOfflineActivity extends Activity {
    ...
    private final String mFrontendModel = "/sdcard/123/tts/frontend_model";
    private final String mBackendModel = "/sdcard/123/tts/backend_lzl";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewTip = findViewById(R.id.textViewTip);
    ...
    private void initTts() {
        ...
        if (!_FrontendModelFile.exists()) {
            ...
            Log.e("logcat","文件：" + mFrontendModel + "不存在，请将assets下相关文件拷贝到SD卡指定目录！");
        }
        ...
        if (!_BackendModelFile.exists()) {
            ...
            Log.e("logcat","文件：" + mBackendModel + "不存在，请将assets下相关文件拷贝到SD卡指定目录！");
        }
        // 设置前端模型
